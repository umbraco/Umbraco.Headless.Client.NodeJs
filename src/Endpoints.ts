...
export const Endpoints = {
  ...
  delivery: {
    ...
    content: {
      ...
      filter: <T extends ContentResponseElement>(body: object, options?: CDNContentFilterOptions) => new Endpoint<PagedResponse<T>>(EndpointSource.CDN, '/content/filter', {}, 'post', options),
